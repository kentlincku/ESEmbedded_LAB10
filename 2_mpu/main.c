...
void set_mpu(void)
{
	...
	REG(MPU_BASE+MPU_RASR_OFFSET)=MPU_RASR_VALUE(MPU_XN_DISABLE,
	MPU_AP_FULL_ACCESS, MPU_TYPE_FLASH, 0, MPU_REGION_SIZE_1MB);
	...
	REG(MPU_BASE+MPU_RASR_OFFSET)=MPU_RASR_VALUE(MPU_XN_ENABLE, 
	MPU_AP_FULL_ACCESS, MPU_TYPE_SRAM, 0, MPU_REGION_SIZE_128KB);
	...
	REG(MPU_BASE+MPU_RASR_OFFSET)=MPU_RASR_VALUE(MPU_XN_ENABLE, 
	MPU_AP_FULL_ACCESS, MPU_TYPE_EXRAM, 0, MPU_REGION_SIZE_32B);
	...
	REG(MPU_BASE+MPU_RASR_OFFSET)=MPU_RASR_VALUE(MPU_XN_ENABLE, 
	MPU_AP_FULL_ACCESS, MPU_TYPE_PERIPHERALS, 0, MPU_REGION_SIZE_32B);
